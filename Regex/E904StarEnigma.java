...
public class E904StarEnigma {
    public static void main(String[] args) {
        ...
        attacked.stream().sorted((a,b)-> a.compareTo(b)).forEach(p -> System.out.printf("-> %s%n", p));

        System.out.printf("Destroyed planets: %d%n", destroyed.size());
        destroyed.stream().sorted((a,b)-> a.compareTo(b)).forEach(p -> System.out.printf("-> %s%n", p));
    }
}
